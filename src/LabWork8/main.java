...
public class main {
    ...
    public static void Buy() {
        ...
        try {
            FileOutputStream outputStream = new FileOutputStream(new File("src\\LabWork8\\Basket.ser"));
    ...
    public static void write(Product[] b) {
        try {
            PrintWriter out = new PrintWriter(new FileOutputStream(new File("src\\LabWork8\\123")));
    ...
    public static void outString(){
        try {
            FileInputStream fileInputStream = new FileInputStream(new File("src\\LabWork8\\Basket.ser"));
            try {
    ...
    static Product bread = new Product("Хлеб", 44.0, 4.3);
    static Product baton = new Product("Батон", 60.0, 5.0);
    static Product cookies = new Product("Печенье", 75.0, 4.9);
    ...
    static Product sausage = new Product("Сосиски", 285.0, 4.8);
    static Product farsh = new Product("Фарш", 250.0, 4.7);
    static Product aspic = new Product("Холодец", 190.0, 4.0);
